...
main_output_dir = "analysis_results_rf_full" 
...
for train_file in all_files:
    ...
    results.append({"Dataset": train_file, "R2 Score": r2, "MSE": mse, "MAE": mae})
    ...
    plt.title(f'Summary Plot for {train_file}');
    plt.tight_layout()
    ...
    plt.title(f'Bar Plot for {train_file}');
    plt.tight_layout()
...
if results:
    ...
    print("\n\n" + "=" * 60)
    print("Final evaluation report of Random Forest regression model")
    print("=" * 60)
